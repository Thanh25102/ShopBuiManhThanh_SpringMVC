      ...
      <div class="col-md-4">
        ...
        <div class="single-sidebar">
          ...
          <div class="thubmnail-recent">
            <img src="<c:url value="/template/img/product-thumb-1.jpg"/>" class="recent-thumb" alt="">
              ...
              <table cellspacing="0" class="shop_table cart">
                ...
                <tr class="cart_item">
                  ...
                  <td class="product-thumbnail">
                    <a href="single-product.html"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="<c:url value="/template/img/product-thumb-2.jpg"/>"></a>
                  </td>
                ...
                <ul class="products">
                  <li class="product">
                    <a href="single-product.html">
                      <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="<c:url value="/template/img/product-2.jpg"/>">
                  ...
                  <li class="product">
                    <a href="single-product.html">
                      <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="<c:url value="/template/img/product-4.jpg"/>">
                      <h3>Ship Your Idea</h3>
                      <span class="price"><span class="amount">£20.00</span></span>
                    </a>
